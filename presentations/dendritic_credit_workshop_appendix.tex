% ---------------------------------------------------------------------------
% dendritic_credit_workshop_appendix.tex — backup slides (6 frames).
% The six strongest backup frames kept in the single-deck build: adjoint
% chain, U(M) derivation + caveat, factorial control battery, validity /
% clean-agreement audit, reliability + same-span, references. The five
