% ---------------------------------------------------------------------------
% dendritic_credit_workshop.tex — master file for the workshop deck.
%
% Single-deck build (pdflatex only): core slides + Backup divider + backup
% frames in ONE PDF —
%   pdflatex -jobname=dendritic_credit_workshop dendritic_credit_workshop.tex
%
...
\hypersetup{pdftitle={What dendritic structure adds to learning},
...
\input{dendritic_credit_workshop_core.tex}
...
\input{dendritic_credit_workshop_appendix.tex}
