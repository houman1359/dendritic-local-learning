...
\textbf{(C)}~Richer or transported feedback improves noise resilience.
\textbf{(D)}~Cue routing probes a branch-specific regime: higher rank helps, while the current pathway-vector implementation does not yet beat the best unstructured low-rank control.}
