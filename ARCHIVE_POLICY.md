...
1. `journal/` is the only active manuscript and the only source uploaded to
   Overleaf.
...
6. Superseded drafts and generated files are recovered from Git or external raw
   archives; they are not stored beside the canonical TeX source.
