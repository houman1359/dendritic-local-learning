...
The Article uses nine main figures. The Supplementary Information uses 36 figures and twelve tables, organized by scientific question. Its contents and main-figure guide locate the supporting methods and comparisons. `figures/README.md` describes the display sequence and reproducible rendering inputs.
