...
def test_figure7_field_is_unweighted_before_weighted_capture():
...
def test_figure7_all_eight_pinky_cells_join_without_identifier_collisions():
    published = read_figure(7)
...
def test_figure7_export_distinguishes_dictionary_and_raw_field_coordinates():
    table = read_figure(7)
...
def test_figure7_microns_ids_join_and_preserve_paired_cell_differences():
    table = read_figure(7)
...
def test_figure8_exact_microns_ids_identify_every_per_cell_mark():
    table = read_figure(8)
...
def test_figure9_source_data_uses_current_panels_and_keeps_nested_units():
    table = read_figure(9)
