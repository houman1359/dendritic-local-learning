...
def test_display_export_covers_all_ten_without_overwriting_direct_tables(tmp_path, monkeypatch):
    ...
    for number in range(1, 11):
        ...
        if number in module.PROVENANCE_DIR:
            ...
            source = tmp_path / "figures/provenance" / module.PROVENANCE_DIR[number] / f"figure_{internal:02d}_plotted.csv"
    ...
    assert [record["figure"] for record in records] == list(range(1, 11))
