...
The Overleaf-synchronized `main` branch tracks manuscript compilation inputs and
publication figures. Research scripts, compact and bulk results, internal reviews,
generated reading copies and the presentation remain local. The September 20
revision also has a durable research snapshot on `kempner_project_b`, located
in the recovery record linked above.
