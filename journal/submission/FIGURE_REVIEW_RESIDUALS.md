> Historical review of the September 2026 drafts, using their then-current figure numbering. The current manuscript has ten main figures and 36 supplementary figures; current display locations are in `../figures/README.md`. Earlier counts and proposed panel swaps are not current unresolved findings.
