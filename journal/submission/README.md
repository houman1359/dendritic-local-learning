...
This directory prepares *Dendritic morphology as a dictionary for local credit assignment* as an Article. The current sequence contains ten main figures and 36 supplementary figures. It follows the task-to-credit argument: neuronal coordinates, branch selection, ancestry grouping, interaction order and learned credit geometry, single-neuron inhibitory selection, population parent-sensitivity rescue, physical depth, anatomy beyond broadcast, ancestry-partition gain and measured responses.
...
The supplement is organized into ten scientific sections with 36 figures and nineteen tables. It retains the capacity and estimation analyses, Boolean controls, prospective-selection failure, optimizer comparisons and biological diagnostics. Main Figures 1, 7 and 8 explain the framework, task architecture and anatomical dictionaries; Figure 4 includes noise controls, Figure 6 tests population selection and parent-sensitivity rescue, and Figure 10 gives the measured-response boundary. The contents and main-figure guide locate every supporting group. The authoritative display map is `../figures/README.md`.
...
The supplement has nineteen tables and ten scientific sections. Repeated display views and revision chronology are excluded from the compiled document. Complete outcomes and source identities remain in the independently indexed Source Data and software.
