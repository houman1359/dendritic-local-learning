...
- [ ] Supply reviewer suggestions or exclusions only if requested by the portal and approved by the authors.
...
- [ ] Review the recorded compilation and layout checks and inspect the compiled main/SI PDFs, including all nine main and 35 supplementary figures.
