...
Matching pairwise and quartic derivative spectra forces unequal target
variances, one and one-half (Section~\ref{sec:degree_relative_noise}). Identical
absolute label noise therefore gives different relative noise. We tested
this alternative explanation directly.

An internally specified protocol used twenty additional paired
