...
$R=G^{-1}$ and $\bm h^{(0)}=R\bm e_s>0$. For a shunt at $k$, let
...
partition dictionary $D_k=\operatorname{diag}(\bm h^{(0)})B_k$. With
...
$1.02\times10^{-6}$. The Source Data indexed in Table~\ref{tab:source_index} retain prespecified
