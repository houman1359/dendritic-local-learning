\begin{figure}[p]
\centering
% 540 pt sheet: at full text width the float and its legend exceed the page by
% 13 pt, so this one is placed at 0.975 (DECISIONS G8; the sheet is already on
% the recorded paste-scale exemption queue).
\includegraphics[width=0.975\textwidth]{supplementary/curated/shunt_sensitivity.pdf}
