...
All eighty shunting fits passed the completeness, source-identity, calibration and checkpoint-selection checks. Mean test accuracies were 34.65\% (strict scalar), 49.74\% (per neuron), 49.15\% (exact path) and 49.12\% (BP). Per-neuron minus scalar accuracy was 15.09 percentage points (95\% paired Student-$t$ interval 13.61--16.57; 20/20 positive), whereas exact minus per neuron was $-0.59$ points ($-0.93$ to $-0.26$; 5/20 positive). Exact minus BP was 0.027 points ($-0.250$ to 0.304). These are fixed-budget descriptive estimates. Strict-scalar seed 22008 reached 400 epochs with a negative validation-loss slope over the last ten epochs, triggering the frozen convergence criterion despite selecting its best checkpoint at epoch 366. Seed 22001 also reached the cap but did not trigger that criterion. All seeds are retained. The unchanged analyzer records the nominal tests, including a BP-equivalence test within the specified margin, but its failed convergence gate withholds confirmatory claims for the cohort. Main Fig.~\ref{fig:framework}E,F and Supplementary Fig.~S6A disclose this limitation; the displayed shunting intervals do not establish converged performance. Historical five-seed shunting pilots remain separate and are not pooled with this extension.
