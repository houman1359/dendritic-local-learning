...
Checkpoint computation displays & Twenty existing opposed-target single-neuron seeds and twenty existing population-rescue seeds; no new training & \ref{note:checkpoint_computation}; all original primary selected checkpoints, Fig.~\ref{fig:si_checkpoint_computation}. \\
