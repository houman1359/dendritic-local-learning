...
5--6 & Local gating, rescue, learned responses and routing & Sections~\ref{note:conductance_learning}--\ref{note:optional_extensions}; Figs.~\ref{fig:si_conductance_grouping}--\ref{fig:si_optional_extensions} \\
