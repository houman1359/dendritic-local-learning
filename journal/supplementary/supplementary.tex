...
10 & Measured-response evidence & Section~\ref{note:measured_responses}; Figs.~\ref{fig:si_measured_transfer_geometry}--\ref{fig:si_measured_predictor_controls} \\
5--6 extensions & Learned responses, approximate signals and routing & Sections~\ref{note:checkpoint_computation}--\ref{note:optional_extensions}; Figs.~\ref{fig:si_checkpoint_computation}--\ref{fig:si_optional_extensions} \\
...
\input{curated/si_04_noise_controls}
\input{curated/si_04_interactions_boolean_figures}
\clearpage

\input{curated/si_05_conductance_learning}
\input{curated/si_05_gate_generalization}
\input{curated/si_05_dendrinet_selection}
\input{curated/si_05_parent_sensitivity}
\input{curated/si_05_sgd_development}
\input{curated/si_05_review_controls}
...
\input{curated/si_11_checkpoint_computation}
\input{curated/si_12_optional_extensions}

\input{curated/si_tables}
\input{curated/si_gate_generalization_table}
\input{curated/si_dendrinet_selection_table}
\input{curated/si_parent_sensitivity_table}
\input{curated/si_review_control_tables}
\input{curated/si_sgd_development_table}
\input{curated/si_population_coordinates_table}
\input{curated/si_optional_extension_table}
\clearpage
