...
This package supports MAIN_COUNT main and SI_COUNT supplementary figures. The main sequence
is framework and image tasks; branch selection; ancestry at matched bandwidth;
interaction order and learned credit geometry; context-dependent conductance
credit; physical depth; anatomical
...
# Display-specific README files are generated from the current manifest below.
from build_submission_bundle import MAIN_FIGURES, MAIN_FIGURE_NUMBERS, SUPPLEMENTARY_FIGURES
README = README.replace("MAIN_COUNT", str(len(MAIN_FIGURE_NUMBERS))).replace(
    "SI_COUNT", str(len(SUPPLEMENTARY_FIGURES)))
