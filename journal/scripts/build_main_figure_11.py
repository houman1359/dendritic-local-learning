#!/usr/bin/env python3
"""Prospective morphology selection, emitted as native component 11.
...
OUT=ROOT/"figures/components/main_figure_11_native.pdf"
...
def build():
    ...
    return canvas.save(OUT,name="main_figure_11_native")
