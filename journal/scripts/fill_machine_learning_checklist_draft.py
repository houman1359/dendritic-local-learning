...
TEXT = {
    ...
    126: "Methods; SI Sections S2-S10: cohort, finite-label, fixed-template and model-class limits.",
    130: "Methods; SI Sections S2/S7-S9: executable preprocessing and response-baseline audit.",
    134: "Methods: anatomy/response joins; SI Sections S7/S9; nested target/scan units.",
    136: "Conductance, linear, multi-affine trees (SI S1/S4/S5).",
    144: "Methods; SI Sections S4/S5/S9/S10: separate task seeds, calibration and stimulus identities.",
    149: "Mechanistic research: rotations; randomized interactions; seven fixed Boolean templates; observed-input visual responses.",
    152: "SI Sections S4/S5/S10: sealed selections; S2/S9: training-only tuning and leakage audit.",
