...
MAIN_FIGURES = tuple(f"main/figure_{n:02d}.pdf" for n in range(1, 11))
MAIN_FIGURE_NUMBERS = tuple(sorted({int(Path(asset).stem.split('_')[1])
                                    for asset in MAIN_FIGURES}))
...
SUPPLEMENTARY_FIGURES = (
    ...
    'supplementary/curated/scalar_tree_capacity.pdf',
    'supplementary/curated/oracle_profile_credit.pdf',
    'supplementary/curated/boolean_capacity.pdf',
    'supplementary/curated/boolean_learning.pdf',
    'supplementary/curated/fixed_profile_budget.pdf',
    'supplementary/curated/credit_optimizer_controls.pdf',
    'supplementary/curated/conductance_grouping.pdf',
    ...
    'supplementary/curated/anatomy_capacity_controls.pdf',
    'supplementary/curated/inhibitory_spatial_controls.pdf',
    'supplementary/curated/coarse_energy.pdf',
...
REQUIRED_FILES = {
    ...
    SUBMISSION / "FIGURE_REVIEW_RESIDUALS.md": Path(
        "submission_materials/FIGURE_REVIEW_RESIDUALS.md"
    ),
...
def write_metadata(output_dir: Path, software: Path | None) -> None:
    ...
    metadata = {
        ...
        "numbered_main_figure_count": len(MAIN_FIGURE_NUMBERS),
