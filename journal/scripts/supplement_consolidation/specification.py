...
PANEL_REASONS = {
 ...
 'S38':'Replaced by the native render N35 (scripts/build_supplementary_figure_finite_horizon_native.py), drawn from the same source tables and pasted whole as Supplementary Fig. S35; no crop of this frozen render is used.',
 'S39':'Replaced by the native render N35 (scripts/build_supplementary_figure_finite_horizon_native.py), drawn from the same source tables and pasted whole as Supplementary Fig. S35; no crop of this frozen render is used.',
 'S41':'Replaced by the native render N36 (scripts/build_supplementary_figure_morphology_estimation_native.py), drawn from the same source tables and pasted whole as Supplementary Fig. S36; no crop of this frozen render is used.',
...
PANEL_CONTENT = {
 ...
 ('S40','C'): dict(content='Paired exact-credit NMSE increase after shuffling leaf input assignments at fixed tree shape and parameter count.',
                   reason='Replaced by panel C of the native render N13, drawn from the same paired-contrast table and printed as S13C; the Adam strips are reproduced at the main-text type scale as Fig. 4H.',
