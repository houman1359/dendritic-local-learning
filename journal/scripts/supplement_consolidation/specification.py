...
PANEL_TEXT_EDITS[('N4C', 'E')] = [('remove', 'Fashion-MNIST')]
...
PANEL_TEXT_EDITS[('N4C', 'C')] = [('remove', 'Shunting CIFAR-10')]
PANEL_TEXT_EDITS[('N4C', 'D')] = [('remove', 'Raw-additive CIFAR-10')]
