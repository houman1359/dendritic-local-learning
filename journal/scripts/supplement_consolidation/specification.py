...
SOURCE_DATA_DIRS = {
 ...
 'image_generalization':['cifar10_shunting_feedback_ladder_confirmatory','cifar10_additive_feedback_ladder_confirmatory','fashion_feedback_ladder','mnist_between_within_factorial','regular_tree_regimes'],
...
NUMERICAL_SOURCE_OVERRIDES[('N4C', 'C')] = ['source_data/cifar10_shunting_feedback_ladder_confirmatory/condition_summary.csv', 'source_data/cifar10_shunting_feedback_ladder_confirmatory/paired_contrasts.csv', 'source_data/cifar10_shunting_feedback_ladder_confirmatory/seed_outcomes.csv', 'source_data/cifar10_shunting_feedback_ladder_confirmatory/summary.json']
