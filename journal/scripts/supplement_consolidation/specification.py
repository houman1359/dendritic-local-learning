...
# ---------------------------------------------------------------- si_05 ----
('conductance_grouping','si_05_conductance_learning',[('S42','ABCDEF')],
...
# Seven of them leave the whole-sheet branch (old S40, S43, S44, S54, S55, S42
# and S50 now paste by letter) so that crops, redactions and re-set labels
# apply; every box is measured on the render in source points.  Replaced in
# place above: old S54 B/D/F and S51 B bounds, the S49 and S37 shared-legend
# boxes (ink union + 2 pt, so build.py's centring lands on the ink) and the
# old S52 A bounds; the stale S52 A redaction box (it sat on D's x spine) is
# deleted.
...
# S14 boolean_capacity
PANEL_BOUNDS[('S43','A')]=[23.8,18.1,250.5,156.8]
PANEL_BOUNDS[('S43','B')]=[278.4,18.1,505.8,152.4]
PANEL_BOUNDS[('S43','C')]=[23.8,175.1,250.5,281.8]
PANEL_BOUNDS[('S43','D')]=[278.4,175.1,505.8,321.3]
PANEL_BOUNDS[('S43','E')]=[23.8,332.1,250.5,464.5]
PANEL_BOUNDS[('S43','F')]=[278.4,332.1,505.8,464.5]
PANEL_REDACTIONS[('S43','A')]=[[88.9,146.0,201.7,155.8]]
PANEL_REDACTIONS[('S43','B')]=[[320.5,141.5,468.6,151.4]]
PANEL_REDACTIONS[('S43','D')]=[[319.1,197.7,425.9,207.6]]
PANEL_REDACTIONS[('S43','E')]=[[108.1,452.6,181.9,463.5]]
PANEL_TEXT[('S43','A')]=[{'text':'input pattern abcd','origin':[116.9,153.2],'fontsize':7.0,'role':'x-axis label, re-set without the colour key'}]
PANEL_TEXT[('S43','B')]=[{'text':'labeled binary tree','origin':[365.3,148.8],'fontsize':7.0,'role':'x-axis label, re-set without the group and marker keys'},{'text':'balanced','origin':[318.0,36.9],'fontsize':7.0,'role':'column-group label over T10-T12 (depth 2)'},{'text':'comb','origin':[400.9,36.9],'fontsize':7.0,'role':'column-group label over T01-T09, T13-T15 (depth 3)'}]
PANEL_TEXT[('S43','C')]=[{'text':'OR','origin':[107.5,216.0],'fontsize':7.0,'role':'gate at the OR(AND) root'},{'text':'AND','origin':[68.0,231.5],'fontsize':7.0,'role':'gate at the OR(AND) left child'},{'text':'AND','origin':[126.0,231.5],'fontsize':7.0,'role':'gate at the OR(AND) right child'},{'text':'AND','origin':[180.0,216.0],'fontsize':7.0,'role':'gate at the nested root'},{'text':'OR','origin':[196.5,231.5],'fontsize':7.0,'role':'gate at the nested middle node'},{'text':'AND','origin':[210.5,247.0],'fontsize':7.0,'role':'gate at the nested bottom node'}]
PANEL_TEXT[('S43','E')]=[{'text':'input pair','origin':[128.4,460.5],'fontsize':8.0,'role':'x-axis label, re-set without the n statement'}]
# S15 boolean_learning
PANEL_BOUNDS[('S44','A')]=[29.0,11.4,273.0,109.8]
PANEL_BOUNDS[('S44','B')]=[281.0,11.4,512.0,109.8]
PANEL_BOUNDS[('S44','C')]=[29.0,130.5,273.0,228.9]
PANEL_BOUNDS[('S44','D')]=[281.0,130.5,512.0,228.9]
PANEL_BOUNDS[('S44','E')]=[29.0,249.7,273.0,345.9]
PANEL_BOUNDS[('S44','F')]=[281.0,249.7,512.0,361.2]
PANEL_BOUNDS[('S44','G')]=[29.0,368.8,273.0,482.9]
PANEL_BOUNDS[('S44','H')]=[281.0,368.8,512.0,479.1]
PANEL_REDACTIONS[('S44','E')]=[[66.4,248.7,247.2,260.5],[141.0,283.8,158.1,337.4]]
PANEL_TEXT[('S44','E')]=[{'text':'Prespecified primary contrasts','origin':[67.4,257.8],'fontsize':8.0,'role':'panel title, re-set without the verdict claim'},{'text':'0.000','origin':[139.6,334.8],'fontsize':7.0,'role':'credit subpanel y tick label, leading zero'},{'text':'0.005','origin':[139.6,313.0],'fontsize':7.0,'role':'credit subpanel y tick label, leading zero'},{'text':'0.010','origin':[139.6,291.1],'fontsize':7.0,'role':'credit subpanel y tick label, leading zero'}]
PANEL_REDACTIONS[('S44','G')]=[[64.5,455.0,122.5,472.4],[159.2,455.0,217.2,472.4],[46.4,396.2,63.5,452.9]]
PANEL_TEXT[('S44','G')]=[{'text':'0.003','origin':[64.9,463.0],'fontsize':7.0,'role':'Adam rate tick label, horizontal'},{'text':'0.01','origin':[87.7,463.0],'fontsize':7.0,'role':'Adam rate tick label, horizontal'},{'text':'0.03','origin':[108.6,463.0],'fontsize':7.0,'role':'Adam rate tick label, horizontal'},{'text':'0.003','origin':[159.5,463.0],'fontsize':7.0,'role':'SGD rate tick label, horizontal'},{'text':'0.01','origin':[182.4,463.0],'fontsize':7.0,'role':'SGD rate tick label, horizontal'},{'text':'0.03','origin':[203.2,463.0],'fontsize':7.0,'role':'SGD rate tick label, horizontal'},{'text':'0.000','origin':[45.5,450.3],'fontsize':7.0,'role':'Adam subpanel y tick label, leading zero'},{'text':'0.005','origin':[45.5,426.9],'fontsize':7.0,'role':'Adam subpanel y tick label, leading zero'},{'text':'0.010','origin':[45.5,403.6],'fontsize':7.0,'role':'Adam subpanel y tick label, leading zero'}]
...
# S18 conductance_grouping
REMOVED_SHARED_REGIONS['S42']=[[180.2,5.7,369.8,24.8]]
SHARED_LEGENDS['conductance_grouping']=[('S42',[180.2,5.7,369.8,24.8])]
PANEL_BOUNDS[('S42','A')]=[0.6,35.0,237.9,113.4]
PANEL_BOUNDS[('S42','B')]=[271.8,35.0,505.2,151.2]
PANEL_BOUNDS[('S42','C')]=[0.6,174.0,237.9,290.2]
PANEL_BOUNDS[('S42','D')]=[271.8,174.0,505.2,290.2]
PANEL_BOUNDS[('S42','E')]=[0.6,313.0,237.9,429.2]
PANEL_BOUNDS[('S42','F')]=[271.8,313.0,505.2,439.3]
PANEL_REDACTIONS[('S42','A')]=[[60.3,114.6,228.7,135.6]]
PANEL_REDACTIONS[('S42','B')]=[[323.3,54.5,466.9,64.4]]
PANEL_REDACTIONS[('S42','C')]=[[50.8,173.8,147.6,186.1],[88.5,187.6,202.0,194.5]]
PANEL_TEXT[('S42','C')]=[{'text':'Adam: all credit rules','origin':[51.84,183.0],'fontsize':8.8,'rotate':0,'role':'panel title re-set with the optimizer name in sentence case, as in E, F and the caption'}]
