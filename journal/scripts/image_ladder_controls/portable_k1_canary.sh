#!/bin/bash
#SBATCH --job-name=mnist_K1_portable
...
/n/holylabs/kempner_dev/Users/hsafaai/Code/.dendritic-modeling-journal-runtimes/release-cleanroom-20260906/bin/python "${SLURM_SUBMIT_DIR}/drafts/dendritic-local-learning/journal/scripts/image_ladder_controls/portable_run.py" \
 ...
 --output-root "/n/holylfs06/LABS/kempner_project_b/Lab/dendritic/HS/LOCAL_LEARNING/journal_extension_20260820/sweep_runs/image_ladder_controls_20260906/portable_k1_cleanenv_canary_${SLURM_ARRAY_TASK_ID}" \
 --stage projected_k1_canary --index "$SLURM_ARRAY_TASK_ID"
