...
def build(*, prepare=False):
    ...
    for asset in layout["assets"]:
        ...
        rows.append(record(asset.get("entry_id", f"creditfirst.{asset['figure']}.asset"), asset["path"],
    ...
    from build_submission_bundle import MAIN_FIGURE_NUMBERS, SUPPLEMENTARY_FIGURES
    expected_main = {f"fig{k}" for k in MAIN_FIGURE_NUMBERS}
