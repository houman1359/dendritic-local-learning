...
\textbf{G}, Paired ancestry-minus-control advantages at $K=8$ on residual (filled) and total (open) capture scales, with all 47 within-cell differences; means and 95\% cell-bootstrap intervals, four of the 188 differences clipped to the axis edge; right: wiring, rank, positive cells.
