...
STANDARD_CFG="${REPO_ROOT}/drafts/dendritic-local-learning/neurips/configs/standard_mnist_pilot_linear_decoder.yaml"
LOCAL_CFG="${REPO_ROOT}/drafts/dendritic-local-learning/neurips/configs/localca_mnist_pilot_linear_decoder.yaml"
