...
SWEEP_DIR="${REPO_ROOT}/drafts/dendritic-local-learning/neurips/configs/sweeps"
...
case "${SUITE}" in
  ...
  claim1|claim2|claim3|claim4)
    ...
    ;;
  *)
    echo "Usage: $0 [all|claim1|claim2|claim3|claim4] [split_jobs] [account] [partition] [submit|generate-only|dry-run]"
    exit 1
    ;;
esac
