...
Usage:
  ...
  python drafts/dendritic-local-learning/neurips/scripts/figure_weight_vs_biology.py \
    --sweep-dirs /path/to/sweep1 /path/to/sweep2 \
    --microns-dir drafts/dendritic-local-learning/neurips/data/microns_distributions \
    --output-dir drafts/dendritic-local-learning/neurips/data/weight_distributions
"""
...
def main():
    ...
    parser.add_argument(
        "--microns-dir",
        default="drafts/dendritic-local-learning/neurips/data/microns_distributions",
        help="Directory with MICrONS analysis results",
    )
    parser.add_argument(
        "--output-dir",
        default="drafts/dendritic-local-learning/neurips/data/weight_distributions",
