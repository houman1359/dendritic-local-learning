...
Usage:
    ...
    PYTHONPATH=src:$PYTHONPATH python drafts/dendritic-local-learning/neurips/scripts/generate_publication_figures.py
"""
...
FIGURES_DIR = (
    ...
    "/drafts/dendritic-local-learning/neurips/figures"
)
