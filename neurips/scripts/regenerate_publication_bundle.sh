...
SWEEP_LIST="${1:-${REPO_ROOT}/drafts/dendritic-local-learning/neurips/configs/publication_sweeps.txt}"
OUTPUT_TAG="${2:-$(date +%Y%m%d_%H%M%S)}"
ANALYSIS_DIR="${3:-${REPO_ROOT}/drafts/dendritic-local-learning/neurips/analysis/publication_bundle_${OUTPUT_TAG}}"
FIGURE_DIR="${4:-${REPO_ROOT}/drafts/dendritic-local-learning/neurips/figures}"
...
SUMMARY_SCRIPT="${REPO_ROOT}/drafts/dendritic-local-learning/neurips/scripts/summarize_neurips_phase_sweeps.py"
FIGURE_SCRIPT="${REPO_ROOT}/drafts/dendritic-local-learning/neurips/scripts/generate_neurips_phase_figures.py"
