...
Usage:
    ...
    PYTHONPATH=src:$PYTHONPATH python drafts/dendritic-local-learning/neurips/scripts/rtot_sensitivity_diagnostic.py

Outputs:
    drafts/dendritic-local-learning/neurips/data/rtot_distributions.csv
    drafts/dendritic-local-learning/neurips/figures/fig_rtot_distributions.pdf
"""
