...
#SBATCH --mem=16GB
#SBATCH --output=/n/holylabs/LABS/kempner_dev/Users/hsafaai/Code/dendritic-modeling/drafts/dendritic-local-learning/neurips/logs/analysis_lcurves_%j.out
#SBATCH --error=/n/holylabs/LABS/kempner_dev/Users/hsafaai/Code/dendritic-modeling/drafts/dendritic-local-learning/neurips/logs/analysis_lcurves_%j.err
