...
LINEAR_CFG="${REPO_ROOT}/drafts/dendritic-local-learning/neurips/configs/localca_mnist_smoke_linear_decoder.yaml"
NONLINEAR_CFG="${REPO_ROOT}/drafts/dendritic-local-learning/neurips/configs/localca_mnist_smoke_nonlinear_decoder.yaml"
